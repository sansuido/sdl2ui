...
class EaseElasticInOut extends ActionEase {
  EaseElasticInOut(Action innerAction) : super(innerAction);
  ...
  void update(double dt) {
    ...
    if (dt != 0 && dt != 1) {
      if (dt < 0.5) {
        value = -(math.pow(2, 20 * dt - 10) * math.sin((20 * dt - 11.125) * c5)) / 2;
      } else {
        value = (math.pow(2, -20 * dt + 10) * math.sin((20 * dt - 11.125) * c5)) / 2 + 1;
      }
    }
